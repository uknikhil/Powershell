...
$dblist=invoke-sqlcmd -server $instance -database master -query "select DB_NAME(database_id) as dbname,name,type,physical_name from sys.master_files where physical_name like 'E:%' and database_id>4"
